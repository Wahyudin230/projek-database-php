                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="text-center">
                                                            <img src="wahyu.jpg" class="img-fluid" alt="Profile Image">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item"><strong>Nama :</strong> Wahyudin</li>
                                                            <li class="list-group-item"><strong>NIM :</strong> 0110123171</li>
